...
public class MeepMeepTesting {
    public static void main(String[] args) {
        ...
        RoadRunnerBotEntity bot = new DefaultBotBuilder(meepMeep)
                ...
                .setConstraints(90, 90, Math.toRadians(180), Math.toRadians(180), 11)
                .followTrajectorySequence(drive ->
                        drive.trajectorySequenceBuilder(new Pose2d(-27.5,65.45, Math.toRadians(0)) //start position & orientation
)
